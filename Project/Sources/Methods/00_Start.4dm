...
Case of 
	: (Count parameters:C259=0)
		...
		If (Application version:C493<"1830")  // 18R3
			ALERT:C41("Sorry, this \"How do I\" (HDI) example must be used with a newer version of 4D (v18 R3 and above)";"Quit")
			QUIT 4D:C291
		Else 
	...
	Else 
		...
		$options.title:="Multiple Web Servers in a single 4D instance"
		
		$options.blog:="https://blog.4d.com/multiple-web-servers-in-a-single-4d-instance"
		$options.info:="Web Server"
